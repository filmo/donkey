...
class KerasCategorical(KerasPilot):
    ...
    def run(self, img_arr):
        ...
        # redundnatly checking angle_len and setting defaults, angle_len should be 15 unless
        # otherwise changed during training of the network.
        angle_len = len(angle_binned)
        angle_unbinned = dk.utils.linear_unbin(angle_binned,N=angle_len, offset=-1, R=2.0)
