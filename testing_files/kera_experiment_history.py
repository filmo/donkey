...
exp_defs.append(exp_n([]))
from testing_files.exp11 import e_def as exp_n
exp_defs.append(exp_n([]))
from testing_files.exp12 import e_def as exp_n
exp_defs.append(exp_n([]))
...
for e in sorted_data:
    print('%25s\tbs:%d \tAug:%d\tVal: %2.5f' %(all_hist[e[0]]['model_base_name'],
                                          e[1],
                                          e[3],
                                          e[5]))
...
for e in sorted_avg:
    print('Exp #%2d %25s \tAug:%d\tVal: %2.5f' % (e[0],all_hist[e[0]]['model_base_name'],
                                                e[7],
                                                e[2]))
